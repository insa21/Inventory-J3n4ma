...
<body>
    ...
    <div class="page-wrapper">
        <aside class="menu-sidebar2">
            <div class="logo">
                <a href="#">
                    <img src="images/icon/jenama.png" alt="Cool Admin" />
                </a>
            </div>
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-archive"></i>Data Produk</a>
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="?page=kelBarang">Semua Produk</a>
                                </li>
                                <li>
                                    <a href="?page=periode">Lihat Produk per Periode</a>
                                </li>
                                <li>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap2">
                            <div class="logo d-block d-lg-none">
                                <a href="#">
                                    <img src="images/icon/jenama.png" alt="CoolAdmin" />
                                </a>
                            </div>
                ...
                <div class="menu-sidebar2__content js-scrollbar2">
                    ...
                    <nav class="navbar-sidebar2">
                        <ul class="list-unstyled navbar__list">
                            ...
                            <li class="has-sub">
                                <a class="js-arrow" href="#">
                                    <i class="fas fa-tachometer-alt"></i>Data Produk</a>
                                <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                    <li>
                                        <a href="?page=kelBarang">Semua Produk</a>
                                    </li>
